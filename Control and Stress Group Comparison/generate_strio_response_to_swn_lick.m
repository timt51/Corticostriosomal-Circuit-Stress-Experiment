...
saveas(f, [fig_dir 'Proportion of Inhibited Pairs in Lick Period'], 'fig');
saveas(f, [fig_dir 'Proportion of Inhibited Pairs in Lick Period'], 'epsc2');
saveas(f, [fig_dir 'Proportion of Inhibited Pairs in Lick Period'], 'jpg');
...
saveas(f, [fig_dir 'Strength to Strength Comparison in Lick Period'], 'fig');
saveas(f, [fig_dir 'Strength to Strength Comparison in Lick Period'], 'epsc2');
saveas(f, [fig_dir 'Strength to Strength Comparison in Lick Period'], 'jpg');