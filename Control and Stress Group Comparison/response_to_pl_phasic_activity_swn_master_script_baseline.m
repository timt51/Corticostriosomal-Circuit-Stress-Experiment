%% This script generates figures showing the proportion of SWNs that
%  have activity that correlate with PLs activity. The variable names here
%  make say 'strio', but the code has been modified so that 'strio' refers
%  to SWNs. In particular, the one necessary change is located on line 34.
%% Find all sessions
...
% min_time = 0; max_time = 2.5;     % (Trial time period) to look for time delays; ie. look from -3s to 2.5s for pls bursts and striosome bursts after those pls bursts
...
%     mkdir(fig_dir)
% end
% saveas(f, [fig_dir 'Proportion of Correlated Pairs in Baseline'], 'fig');
% saveas(f, [fig_dir 'Proportion of Correlated Pairs in Baseline'], 'jpg');
% saveas(f, [fig_dir 'Proportion of Correlated Pairs in Baseline'], 'epsc2');
...
%     mkdir(fig_dir)
% end
% saveas(f, [fig_dir 'Peak of Time Delays in Baseline'], 'fig');
% saveas(f, [fig_dir 'Peak of Time Delays in Baseline'], 'jpg');
% saveas(f, [fig_dir 'Peak of Time Delays in Baseline'], 'epsc2');