...
min_time = 3; max_time = 15;     % (Trial time period) to look for time delays; ie. look from -3s to 2.5s for pls bursts and striosome bursts after those pls bursts
...
saveas(f, [fig_dir 'Proportion of Correlated Pairs in Lick'], 'fig');
saveas(f, [fig_dir 'Proportion of Correlated Pairs in Lick'], 'jpg');
saveas(f, [fig_dir 'Proportion of Correlated Pairs in Lick'], 'epsc2');
...
saveas(f, [fig_dir 'Peak of Time Delays in Lick'], 'fig');
saveas(f, [fig_dir 'Peak of Time Delays in Lick'], 'jpg');
saveas(f, [fig_dir 'Peak of Time Delays in Lick'], 'epsc2');