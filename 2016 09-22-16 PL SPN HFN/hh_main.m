% %% Hodgkin-Huxley circuit model implemented by Leif Gibb 6/28/15 through 9/22/16
...
% all_ids = {cb_pl_ids,cb_pls_ids,cb_strio_ids,cb_matrix_ids,cb_hfn_ids,cb_swn_ids};
% rmpath('./2016 09-10-16 PL SPN HFN');
%%
% close all
clear Nneur Nsyn
tic
...
clear PL
PL.signaltype = 3; % Case 1: PL neurons are sequentially active. Case 2: PL neurons are all stimulated at one timepoint.
Nneur.PL = 14;
PL.spikedur = 1; % ms
...
Nsyn.syn12 = Nneur.PL;
clear syn12
syn12.gsyn = 0.4; % 0.3; %0.2; % mS/cm^2
syn12.Tmax = 1.5; % mM
syn12.Erev = 0; % mV
